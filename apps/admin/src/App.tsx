      ...
      <section className="dashboard-start panel" aria-labelledby="dashboard-start-title">
        ...
        <div className="dashboard-start__actions">
          ...
          {session.principal.role === "read_only_reviewer" && <>
            ...
            <button type="button" onClick={() => setPage("locations")}><span><MapPin size={16} /></span><strong>Open a location</strong><small>Review assigned operating sites</small><ChevronRight size={15} /></button>
          </>}
